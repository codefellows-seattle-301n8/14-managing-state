...
(function(module) {
  ...
  // 'Handlebars.compile' compiles the stringified text of the article. It takes this text and runs parseInt to render the publishedOn information in date format. The function lives in the marked.js file. 
