...
(function(module) {
  ...
  // This function is called in routes.js. Ctx.articles is defined by the function that is called before it in the route. And will load information based on that function.
  ...
  articleController.loadById = (ctx, next) => {
    ...
    // COMMENT: What is this function doing? Where is it called? Does it call any other functions, and if so, in what file(s) do those function(s) live?
    //  This function lets the user to sort articles based on a specified piece of information, depends on what is being passed in. This function lives in the "article.js" file
