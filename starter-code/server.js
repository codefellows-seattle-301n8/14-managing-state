...
const conString = 'postgres://postgres@localhost:5432'; // TODO: Don't forget to set your own conString
...
// (put your response in a comment here) The function is running the requestProxy on the github API. requestProxy is a type of request that uses the local uri. the request uses template strings to insert information.
...
// (put your response in a comment here) Whenever there is a get request on a root path we send the data in callback funtion.
...
// COMMENT: What is this route doing? Where does it receive a request from?
// (put your response in a comment here) it receives a request from the controller and then runs a SQL query based on the request.
