...
// This function is requesting authorization from github to eventually get all of our repository information.
...
// It is recieving the request from new.html and it is telling the path /new to open ./public/new.html.
...
// COMMENT: What is this route doing? Where does it receive a request from?
// There is query being made to update the table 'authors' and then the table 'articles' with information that is coming from our JSON file.
