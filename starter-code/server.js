...
// This function retrieving information from github.  We need this function becuase it determines where to get the information from, what informatin to get and the token needed to do so.   It receives a request from the client.
...
// They all receinve a request from the client.  The first two come from the website url and will request their respective html files based on the url.  The third comes from the requestRepos function in repo.js and will run the proxyGitHub function with directory stated as the request.params.
...
// COMMENT: What is this route doing? Where does it receive a request from?
// This route is updating author and article information based on the id put into the url.  It recieves its request from a url change in the client.
